...
\DeclareMathOperator*{\highway}{Highway}
\DeclareMathOperator*{\elmo}{ELMo}

%\newcommand{\leftctxfn}{\overrightarrow{\mathcal{C}}}
%\newcommand{\rightctxfn}{\overleftarrow{\mathcal{C}}}
\newcommand{\elmoleftctxfn}{\overrightarrow{\text{LSTM}}}
\newcommand{\elmorightctxfn}{\overleftarrow{\text{LSTM}}}
\newcommand{\ctx}{\mathbf{h}}
\newcommand{\ctxp}{\mathbf{h}^*}
\newcommand{\leftctx}{\overrightarrow{\mathbf{h}}}
\newcommand{\leftctxp}{\overrightarrow{\mathbf{h}^*}}
\newcommand{\leftctxpp}{\overrightarrow{\mathbf{h}^{'}}}
\newcommand{\rightctx}{\overleftarrow{\mathbf{h}}}
%\newcommand{\bigv}{\mathbf{\tilde{v}}}

\newcommand{\stdev}[1]{\tiny ($\pm$#1)}
...
%\end{figure} %debug 选项
%\include{body/format_guidance}
\include{body/intro}
\include{body/elmo}
\include{body/semicrf}
\include{body/seqlabel}
\include{body/distill}
\backmatter
%硕博书序
